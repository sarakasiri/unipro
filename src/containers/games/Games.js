                    ...
                    <Grid item xs={12}>
                        <div className={classes.corridorImg} id='corridorImg'>
                            ...
                            <div className={classes.gameTitle}>
                                <h1 className={classes.persianTitle}>میراژ</h1>
                                <h1 className={classes.englishTitle}>Mirage</h1>
                                <h1 className={`${classes.persianTitle} ${classes.persianTitle2}`}>اتاق فراری ترسناک و هیجان انگیز</h1>
                            </div>
                        </div>
                    </Grid>
                    <Grid item xs={12}>
